...
//
    @Override public void onDropViewInstance(HasIndicatorsHorizonVerticalView view) {
    ...
    public void receiveCommand(HasIndicatorsHorizonVerticalView view , int commandId, @Nullable ReadableArray args) {
        switch (commandId) {
            case 1:
                ...
                VerticalViewPager v = (VerticalViewPager) reactContexts.getCurrentActivity().findViewById(R.id.list);
                if (v!=null){
                    v.requestLayout();
                }
